    ...
    <div class="mx-auto col-md-6 bg-light">
        ...
        <form action="<?php echo URLROOT; ?>/users/login" method="post">
            ...
            <div class="form-floating m-1">
                <input type="email" id="email" name="email" class="form-control <?php echo (!empty($data['email_error'])) ? 'is-invalid' : ''; ?>" placeholder=" " value="<?php echo $data['email']; ?>">
                <label for="email" class="form-label">Email</label>
                <span class="invalid-feedback"><?php echo $data['email_error']; ?></span>
            </div>

            <div class="form-floating m-1">
                <input type="password" id="password" name="password" class="form-control <?php echo (!empty($data['password_error'])) ? 'is-invalid' : ''; ?>" placeholder=" " value="<?php echo $data['password']; ?>">
