    ...
    <div class="mx-auto col-md-6 bg-light">
        ...
        <form action="<?php echo URLROOT; ?>/users/register" method="post">
            ...
            <div class="form-floating m-1">
                <input type="text" id="username" class="form-control <?php echo (!empty($data['_error'])) ? 'is_invalid' : ''; ?>" placeholder=" " value="<?php echo $data['username']; ?>">
            ...
            <div class="form-floating m-1">
                <input type="password" id="confirm_password" class="form-control <?php echo (!empty($data['_error'])) ? 'is_invalid' : ''; ?>" placeholder=" " value="<?php echo $data['confirm_password']; ?>">
