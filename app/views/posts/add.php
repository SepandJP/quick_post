    ...
    <div class="mx-auto bg-light p-2">
        ...
        <form action="<?php echo URLROOT; ?>/posts/add" method="post">
            ...
            <div class="form-floating m-1 mb-3">
                <input type="text" id="title" name="title" class="form-control <?php echo (!empty($data['title_error'])) ? 'is_invalid' : ''; ?>" placeholder=" " value="<?php echo $data['title']; ?>">
                <label for="title" class="form-label">Title</label>
                <span class="invalid-feedback"><?php echo $data['title_error']; ?></span>
            </div>

            <div class="form-floating m-1">
                <textarea name="body" id="body" rows="500" class="form-control form-control-lg <?php echo (!empty($data['body_error'])) ? 'is_invalid' : ''?>"><?php echo $data['body'];?></textarea>
